                ...
                <div class="row">
                    <div class="col-9 col-sm-6" id="code">
                        ...
                        <div class="d-flex align-items-center">
                            <input type="text" class="form-control" readonly value="<?= $person['accounting_code'] ?>">
                    ...
                    <div class="col-12" id="company">
                        <label>شرکت</label>
                        <input type="text" class="form-control" name="company" value="<?= $person['company'] ?>">
                    </div>
                    ...
                    <div class="col-12" id="display">
                        ...
                        <input type="text" class="form-control" name="display_name" value="<?= $person['display_name'] ?>">
                    </div>
                    <div class="col-12" id="category">
                        <label>دسته بندی</label>
                        <select class="form-control" name="category">
                            <option><?= $person['category'] ?></option>
                        </select>
                    </div>
                    <div class="col-12">
                        <label>نوع</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="customer" name="type[]" value="مشتری" <?= in_array('مشتری', explode(',', $person['type'])) ? 'checked' : '' ?>>
                            <label class="form-check-label" for="customer">مشتری</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="supplier" name="type[]" value="تامین کننده" <?= in_array('تامین کننده', explode(',', $person['type'])) ? 'checked' : '' ?>>
                            <label class="form-check-label" for="supplier">تامین کننده</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="shareholder" name="type[]" value="سهامدار" <?= in_array('سهامدار', explode(',', $person['type'])) ? 'checked' : '' ?>>
                            <label class="form-check-label" for="shareholder">سهامدار</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="employee" name="type[]" value="کارمند" <?= in_array('کارمند', explode(',', $person['type'])) ? 'checked' : '' ?>>
        ...
        <div class="p-3">
            <div id="general" class="tab-content">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="number" class="form-control" name="financial_credit" value="<?= $person['financial_credit'] ?>">
                    </div>
                    <div class="col-sm-4">
                        <label>لیست قیمت</label>
                        <select class="form-control" name="price_list">
                            <option><?= $person['price_list'] ?></option>
                        </select>
                    </div>
                    <div class="col-sm-4">
                        <label>نوع مالیات</label>
                        <select class="form-control" name="tax_type">
                            <option><?= $person['tax_type'] ?></option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="national_code" value="<?= $person['national_code'] ?>">
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <label>کد اقتصادی</label>
                        <input type="text" class="form-control" name="economic_code" value="<?= $person['economic_code'] ?>">
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <label>شماره ثبت</label>
                        <input type="text" class="form-control" name="registration_number" value="<?= $person['registration_number'] ?>">
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <label>کد شعبه</label>
                        <input type="text" class="form-control" name="branch_code" value="<?= $person['branch_code'] ?>">
                    </div>
                    <div class="col-12">
                        <label>توضیحات</label>
                        <textarea class="form-control" rows="3" name="description"><?= $person['description'] ?></textarea>
                    </div>
                </div>
            </div>
            <div id="address" class="tab-content hidden">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <label>کشور</label>
                        <input type="text" class="form-control" name="country" value="<?= $person['country'] ?>">
                    </div>
                    <div class="col-sm-6">
                        <label>استان</label>
            ...
            <div id="contact" class="tab-content hidden">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <label>فکس</label>
                        <input type="text" class="form-control" name="fax" value="<?= $person['fax'] ?>">
                    </div>
                    <div class="col-sm-4">
                        <label>تلفن ۱</label>
                        <input type="text" class="form-control" name="phone1" value="<?= $person['phone1'] ?>">
                    </div>
                    <div class="col-sm-4">
                        <label>تلفن ۲</label>
                    ...
                    <div class="col-sm-4">
                        <label>تلفن ۳</label>
                        <input type="text" class="form-control" name="phone3" value="<?= $person['phone3'] ?>">
                    </div>
                    <div class="col-sm-6">
                        <label>ایمیل</label>
            ...
            <div id="bank" class="tab-content hidden">
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="bank_name" value="<?= $person['bank_name'] ?>">
                    </div>
                    <div class="col-12">
                        <label>شماره حساب</label>
                        <input type="text" class="form-control" name="account_number" value="<?= $person['account_number'] ?>">
                    </div>
                    <div class="col-12">
                        <label>شماره کارت</label>
                        <input type="text" class="form-control" name="card_number" value="<?= $person['card_number'] ?>">
                    </div>
                    <div class="col-12">
                        <label>شماره شبا</label>
                        <input type="text" class="form-control" name="sheba_number" value="<?= $person['sheba_number'] ?>">
                    </div>
                </div>
            </div>
            <div id="other" class="tab-content hidden">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="date" class="form-control" name="marriage_date" value="<?= $person['marriage_date'] ?>">
                    </div>
                    <div class="col-sm-4">
                        <label>تاریخ عضویت</label>
                        <input type="date" class="form-control" name="membership_date" value="<?= $person['membership_date'] ?>">
                    </div>
                </div>
            </div>
        </div>
